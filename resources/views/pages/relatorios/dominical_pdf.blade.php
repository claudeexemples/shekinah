...
<div class="grid-3" style="margin-bottom:var(--space-5);">
  ...
  <div style="background:var(--color-neutral-0);border:1px solid var(--color-neutral-200);border-radius:var(--radius-xl);padding:var(--space-5);">
    ...
    @if($culto->oferta)
    <div class="summary-row"><span class="sr-label">Dinheiro</span><span class="sr-value">{{ number_format($culto->oferta->valor_dinheiro,0,',','.') }} Kz</span></div>
    <div class="summary-row"><span class="sr-label">Transferência/EMIS</span><span class="sr-value">{{ number_format($culto->oferta->valor_transferencia,0,',','.') }} Kz</span></div>
    <div class="summary-row"><span class="sr-label">Multicaixa/TPA</span><span class="sr-value">{{ number_format($culto->oferta->valor_cartao,0,',','.') }} Kz</span></div>
    <div class="summary-row"><span class="sr-label" style="font-weight:600;">Total</span><span class="sr-value" style="color:var(--color-success-700);font-weight:700;">{{ number_format($culto->oferta->valor_total,0,',','.') }} Kz</span></div>
    @else<p style="color:var(--color-neutral-400);font-size:var(--text-sm);">Não registada</p>@endif
  </div>
</div>
