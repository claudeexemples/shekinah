...
<title><?php echo $__env->yieldContent('title', 'Dashboard'); ?> — Shekinah</title>
...
<div class="app-wrapper">
  ...
  <aside class="sidebar" id="sidebar">
    ...
    <nav class="sidebar__nav">
      ...
      <a href="<?php echo e(route('cultos.index')); ?>" class="nav-item <?php echo e(request()->routeIs('cultos.*') ? 'active' : ''); ?>">
      ...
      <a href="<?php echo e(route('ebd.index')); ?>" class="nav-item <?php echo e(request()->routeIs('ebd.*') ? 'active' : ''); ?>">
      ...
      <a href="<?php echo e(route('celestial.index')); ?>" class="nav-item <?php echo e(request()->routeIs('celestial.*') ? 'active' : ''); ?>">
      ...
      <a href="<?php echo e(route('doutrinaria.index')); ?>" class="nav-item <?php echo e(request()->routeIs('doutrinaria.*') ? 'active' : ''); ?>">
      ...
      <a href="<?php echo e(route('visitantes.index')); ?>" class="nav-item <?php echo e(request()->routeIs('visitantes.*') ? 'active' : ''); ?>">
      ...
      <a href="<?php echo e(route('financeiro.index')); ?>" class="nav-item <?php echo e(request()->routeIs('financeiro.*') ? 'active' : ''); ?>">
      ...
      <a href="<?php echo e(route('relatorios.index')); ?>" class="nav-item <?php echo e(request()->routeIs('relatorios.*') ? 'active' : ''); ?>">
  ...
  <main class="main-content">
    <header class="header">
      <div>
        <h1 class="header__page-title"><?php echo $__env->yieldContent('page-title', 'Dashboard'); ?></h1>
      ...
      <div class="header__right">
        <span style="font-size:var(--text-sm);color:var(--color-neutral-500);font-weight:500;padding:var(--space-2) var(--space-3);background:var(--color-neutral-50);border:1px solid var(--color-neutral-200);border-radius:var(--radius-md);">
          <?php echo e(now()->locale('pt')->isoFormat('ddd, DD/MM/YYYY')); ?>
...
<?php /**PATH /home/cj/Transferências/shekinah (2)/shekinah/resources/views/layouts/app.blade.php ENDPATH**/ ?>